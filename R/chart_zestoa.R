...
location = "Etorraberri"
date_start = ymd("2020-09-06") #Date that the trip started to this location
date_post = ymd("2020-10-11") #Date when you wrote the post



exit_folder = file.path(dir_charts, "Zestoa")
...
##Line after
  ...
  geom_text_repel(
    ...
    aes(label = c("Uncastillo", "Cinfaes")),
    nudge_x = 30,
    segment.size  = .5,
